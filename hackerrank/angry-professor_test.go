...
func TestAngryProfessor(t *testing.T) {
	...
	input := map[int32][]int32{
		// int32(3): []int32{-1, -3, 4, 2},
		// int32(2): []int32{0, -1, 2, 1},

		// int32(4): {-93, -86, 49, -62, -90, -63, 40, 72, 11, 67},
		// int32(10): {23, -35, -2, 58, -67, -56, -42, -73, -19, 37},
		// int32(9): {13, 91, 56, -62, 96, -5, -84, -36, -46, -13},
		int32(8): {45, 67, 64, -50, -8, 78, 84, -51, 99, 60},
		int32(7): {26, 94, -95, 34, 67, -97, 17, 52, 1, 86},
	}
	for i := range input {
		fmt.Println("first test case: ", AngryProfessor(i, input[i]))
	}
